...
add_urls("https://github.com/facebook/yoga/archive/refs/tags/$(version).tar.gz", "https://github.com/facebook/yoga.git")
...
add_urls("https://github.com/madler/zlib/archive/refs/tags/$(version).tar.gz", "https://github.com/madler/zlib.git")
...
add_patches(
	"2.11.0",
	path.join(os.scriptdir(), "patches", "2.11.0", "writing_system.patch"),
...
add_configs(
	"png",
	{ description = "Support PNG compressed OpenType embedded bitmaps", default = false, type = "boolean" }
)
add_configs(
	"woff2",
	{ description = "Use Brotli library to support decompressing WOFF2 fonts", default = false, type = "boolean" }
)
				...
				if fetchinfo then
					table.insert(
						...
						"-D"
							.. includeconf
							.. "="
							.. table.concat(fetchinfo.includedirs or fetchinfo.sysincludedirs, ";")
					)
