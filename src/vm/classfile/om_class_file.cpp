    ...
    case "StackMapTable"_hash: {
        ...
        for (uint16_t i = 0; i < noe; i++)
        {
            ...
            else if (fr->tag < 255)
            {
                ...
                fr->appendFrame.locals = std::make_unique<std::vector<OMClassAttrVerifyTypeInfo>>();
            ...
            else
            {
                ...
                fr->fullFrame.locals = std::make_unique<std::vector<OMClassAttrVerifyTypeInfo>>();
                ...
                fr->fullFrame.stackItems = std::make_unique<std::vector<OMClassAttrVerifyTypeInfo>>();
